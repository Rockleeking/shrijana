...
$artid=$row["art_id"];
 echo'<div style="float:left; font-size:15px; margin:25px 0 0 0;">
    ...
    <div class="latestarticle2" style="font-size:15px;">'.$row["Descp"].'<div align="right" class="allreadmore" style="margin:2px 0 10px 0;">Name:'.$row["Name"].'  | Class: '.$row["Degination"].'</div></div>';
	
	echo "<br />";
	echo '<a href="managearticle.php?artid='.$artid.'"> Delete</a> <br />';
	}
