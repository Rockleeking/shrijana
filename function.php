...
$artDesi=$_POST['artDesi'];
/*echo $fname;
echo $uname;
echo $pwd;*/

$sql1='INSERT INTO tbl_article(Title,Descp,Name,Degination) VALUES("'.$artTitle.'","'.$artDesc.'","'.$artName.'","'.$artDesi.'")';
$result1=mysql_query($sql1,$connection);
if($result1>0){
	echo "Article addedsss";
...
?>
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr align="left">
    <td width="22%" align="left"  height="40">Title:</td>
    <td width="78%" align="left"  ><input type="text" name="artTitle" value="" /></td>
    </tr>
    
    <tr align="left">
    <td width="22%" align="left"  height="40">Description:</td>
    <td width="78%" align="left"  ><textarea name="artDesc" cols="40" rows="10"></textarea></td>
    </tr>
	<tr align="left">
    <td width="22%" align="left"  height="40">Name:</td>
    <td width="78%" align="left"  ><input type="text" name="artName" value="" /></td>
    </tr>
	<tr align="left">
    <td width="22%" align="left"  height="40">Designation:</td>
    <td width="78%" align="left"  ><input type="text" name="artDesi" value="" /></td>
    </tr>
    <tr align="left">
    <td width="22%" align="left"  height="40"><input type="reset" name="clearbtn" value="Clear" /></td>
    <td width="78%" align="left"  ><input type="submit" name="artsubmitbtn" value="submit" /></td>
    </tr>
    </table>
</form>
    </div>
